...
using ClubFitnessDatabaseUpgrader.Properties;

namespace ClubFitnessDatabaseUpgrader
{
class Program
{
    ...
    {
        return ConfigurationManager.ConnectionStrings["ClubFitnessDB"].ConnectionString;
    }
